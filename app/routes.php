...
Route::get('/', function()
{
		...
		return View::make('index')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menutype2'=>$menutype2,
...
Route::get('buy/artworks', function()
{
		...
		return View::make('buy/artworks')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/ceramics-pottery', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/paintings-prints', function()
{
		...
		return View::make('buy/artworks/paintings-prints')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/glass', function()
{
		...
		return View::make('buy/artworks/glass')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate4'=>$menucate4,
...
Route::get('buy/artworks/drawings-illustration', function()
{
		...
		return View::make('buy/artworks/drawings-illustration')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/crafts-otherarts', function()
{
		...
		return View::make('buy/artworks/crafts-otherarts')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate6'=>$menucate6,
...
Route::get('buy/artworks/sculptures-carvings/abstract', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/animals', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/fountains-waterfalls', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/fountains-waterfalls')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/science-technology', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/science-technology')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/other-sculptures-carvings', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/other-sculptures-carvings')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/ceramics-pottery/bowls-pots', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery/bowls-pots')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/ceramics-pottery/candle-holders', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery/candle-holders')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/ceramics-pottery/childrens-art', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery/childrens-art')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/ceramics-pottery/cups-goblets', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery/cups-goblets')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/ceramics-pottery/fountains-waterfalls', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery/fountains-waterfalls')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/ceramics-pottery/jars', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery/jars')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/ceramics-pottery/jewelry', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery/jewelry')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/ceramics-pottery/tiles', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery/tiles')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/ceramics-pottery/vases-urns', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery/vases-urns')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/ceramics-pottery/other-ceramics-pottery', function()
{
		...
		return View::make('buy/artworks/ceramics-pottery/other-ceramics-pottery')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate2'=>$menucate2,
...
Route::get('buy/artworks/paintings-prints/abstract', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/animals', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/people-figures', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/science-technology', function()
{
		...
		return View::make('buy/artworks/paintings-prints/science-technology')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/politics-patriotism', function()
{
		...
		return View::make('buy/artworks/paintings-prints/politics-patriotism')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/other-paintings-prints', function()
{
		...
		return View::make('buy/artworks/paintings-prints/other-paintings-prints')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/glass/bead', function()
{
		...
		return View::make('buy/artworks/glass/bead')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate4'=>$menucate4,
...
Route::get('buy/artworks/glass/bowls-pots', function()
{
		...
		return View::make('buy/artworks/glass/bowls-pots')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate4'=>$menucate4,
...
Route::get('buy/artworks/glass/candle-holders', function()
{
		...
		return View::make('buy/artworks/glass/candle-holders')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate4'=>$menucate4,
...
Route::get('buy/artworks/glass/jars', function()
{
		...
		return View::make('buy/artworks/glass/jars')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate4'=>$menucate4,
...
Route::get('buy/artworks/glass/jewelry', function()
{
		...
		return View::make('buy/artworks/glass/jewelry')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate4'=>$menucate4,
...
Route::get('buy/artworks/glass/mirrors', function()
{
		...
		return View::make('buy/artworks/glass/mirrors')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate4'=>$menucate4,
...
Route::get('buy/artworks/glass/vases-urns', function()
{
		...
		return View::make('buy/artworks/glass/vases-urns')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate4'=>$menucate4,
...
Route::get('buy/artworks/glass/other-glass', function()
{
		...
		return View::make('buy/artworks/glass/other-glass')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate4'=>$menucate4,
...
Route::get('buy/artworks/drawings-illustration/abstract', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/animals', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/fountains-waterfalls', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/fountains-waterfalls')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/science-technology', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/science-technology')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/other-drawings-illustration', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/other-drawings-illustration')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/crafts-otherarts/basketry', function()
{
		...
		return View::make('buy/artworks/crafts-otherarts/basketry')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate6'=>$menucate6,
...
Route::get('buy/artworks/crafts-otherarts/beadwork', function()
{
		...
		return View::make('buy/artworks/crafts-otherarts/beadwork')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate6'=>$menucate6,
...
Route::get('buy/artworks/crafts-otherarts/birdhouses-birdcages', function()
{
		...
		return View::make('buy/artworks/crafts-otherarts/birdhouses-birdcages')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate6'=>$menucate6,
...
Route::get('buy/artworks/crafts-otherarts/birdfeeders', function()
{
		...
		return View::make('buy/artworks/crafts-otherarts/birdfeeders')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate6'=>$menucate6,
...
Route::get('buy/artworks/crafts-otherarts/boxes', function()
{
		...
		return View::make('buy/artworks/crafts-otherarts/boxes')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate6'=>$menucate6,
...
Route::get('buy/artworks/crafts-otherarts/candles', function()
{
		...
		return View::make('buy/artworks/crafts-otherarts/candles')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate6'=>$menucate6,
...
Route::get('buy/artworks/crafts-otherarts/leathercraft', function()
{
		...
		return View::make('buy/artworks/crafts-otherarts/leathercraft')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate6'=>$menucate6,
...
Route::get('buy/artworks/crafts-otherarts/toys', function()
{
		...
		return View::make('buy/artworks/crafts-otherarts/toys')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate6'=>$menucate6,
...
Route::get('buy/artworks/crafts-otherarts/other-craft-arts', function()
{
		...
		return View::make('buy/artworks/crafts-otherarts/other-craft-arts')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate6'=>$menucate6,
...
Route::get('buy/artworks/sculptures-carvings/abstract/collage', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract/collage')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/abstract/colour', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract/colour')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/abstract/figurative', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract/figurative')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/abstract/geometric', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract/geometric')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/abstract/irregular-forms', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract/irregular-forms')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/abstract/landscape', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract/landscape')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/abstract/man-made-objects', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract/man-made-objects')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/abstract/text', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract/text')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/abstract/organic', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract/organic')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/abstract/other-abstract', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/abstract/other-abstract')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/animals/aquatic-life', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/aquatic-life')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/animals/birds', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/birds')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/animals/insect-bugs', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/insect-bugs')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/animals/dogs-puppies', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/dogs-puppies')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/animals/farm-animals', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/farm-animals')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/animals/other-animals', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/other-animals')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/british', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/british')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/americana', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/americana')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/egyptian', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/egyptian')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/italian', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/italian')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/mexican', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/mexican')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/russian', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/russian')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/others', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/others')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/plants', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/plants')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/trees', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/trees')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/others', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/others')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/science-technology/ecology', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/science-technology/ecology')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/science-technology/space', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/science-technology/space')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/science-technology/history', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/science-technology/history')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/science-technology/medicine', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/science-technology/medicine')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/science-technology/people', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/science-technology/people')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/science-technology/research', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/science-technology/research')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/sculptures-carvings/science-technology/others', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/science-technology/others')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate1'=>$menucate1,
...
Route::get('buy/artworks/paintings-prints/abstract/collage', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract/collage')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/abstract/colour', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract/colour')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/abstract/figurative', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract/figurative')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/abstract/geometric', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract/geometric')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/abstract/irregular-forms', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract/irregular-forms')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/abstract/landscape', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract/landscape')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/abstract/man-made-objects', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract/man-made-objects')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/abstract/text', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract/text')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/abstract/organic', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract/organic')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/abstract/other-abstract', function()
{
		...
		return View::make('buy/artworks/paintings-prints/abstract/other-abstract')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/animals/aquatic-life', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/aquatic-life')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/animals/birds', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/birds')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/animals/insect-bugs', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/insect-bugs')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/animals/dogs-puppies', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/dogs-puppies')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/animals/farm-animals', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/farm-animals')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/animals/other-animals', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/other-animals')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/flowers', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/flowers')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/plants', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/plants')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/trees', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/trees')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/people-figures/celebrity', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/celebrity')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/people-figures/dance', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/dance')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/people-figures/animation-anime-comics', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/animation-anime-comics')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/people-figures/occupations', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/occupations')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/people-figures/potrait', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/potrait')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/african', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/african')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/british', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/british')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/americana', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/americana')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/egyptian', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/egyptian')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/italian', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/italian')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/mexican', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/mexican')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/russian', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/russian')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/others', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/others')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/science-technology/ecology', function()
{
		...
		return View::make('buy/artworks/paintings-prints/science-technology/ecology')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/science-technology/energy', function()
{
		...
		return View::make('buy/artworks/paintings-prints/science-technology/energy')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/science-technology/history', function()
{
		...
		return View::make('buy/artworks/paintings-prints/science-technology/history')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/science-technology/medicine', function()
{
		...
		return View::make('buy/artworks/paintings-prints/science-technology/medicine')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/science-technology/people', function()
{
		...
		return View::make('buy/artworks/paintings-prints/science-technology/people')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/science-technology/research', function()
{
		...
		return View::make('buy/artworks/paintings-prints/science-technology/research')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/science-technology/space', function()
{
		...
		return View::make('buy/artworks/paintings-prints/science-technology/space')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/science-technology/others', function()
{
		...
		return View::make('buy/artworks/paintings-prints/science-technology/others')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/politics-patriotism/flags-symbols', function()
{
		...
		return View::make('buy/artworks/paintings-prints/politics-patriotism/flags-symbols')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/politics-patriotism/law', function()
{
		...
		return View::make('buy/artworks/paintings-prints/politics-patriotism/law')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/politics-patriotism/military-war', function()
{
		...
		return View::make('buy/artworks/paintings-prints/politics-patriotism/military-war')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/politics-patriotism/politics', function()
{
		...
		return View::make('buy/artworks/paintings-prints/politics-patriotism/politics')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/paintings-prints/politics-patriotism/other-politics-patriotism', function()
{
		...
		return View::make('buy/artworks/paintings-prints/politics-patriotism/other-politics-patriotism')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate3'=>$menucate3,
...
Route::get('buy/artworks/drawings-illustration/abstract/collage', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/collage')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/abstract/colour', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/colour')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/abstract/figurative', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/figurative')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/abstract/geometric', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/geometric')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/abstract/irregular-forms', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/irregular-forms')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/abstract/landscape', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/landscape')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/abstract/man-made-objects', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/man-made-objects')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/abstract/movement', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/movement')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/abstract/text', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/text')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/abstract/organic', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/organic')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/abstract/other-abstract', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/abstract/other-abstract')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/animals/aquatic-life', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/aquatic-life')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/animals/birds', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/birds')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/animals/insect-bugs', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/insect-bugs')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/animals/dogs-puppies', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/dogs-puppies')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/animals/farm-animals', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/farm-animals')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/animals/other-animals', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/other-animals')->with(array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
											   'menucate5'=>$menucate5,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian')->with(
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/americana', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/americana')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/egyptian', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/egyptian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/italian', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/italian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/mexican', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/mexican')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/russian', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/russian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/british', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/british')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/others', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/others')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/flowers', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/flowers')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/plants', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/plants')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/trees', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/trees')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/others', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/others')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/science-technology/ecology', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/science-technology/ecology')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/science-technology/energy', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/science-technology/energy')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/science-technology/history', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/science-technology/history')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/science-technology/medicine', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/science-technology/medicine')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/science-technology/people', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/science-technology/people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/science-technology/research', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/science-technology/research')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/science-technology/space', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/science-technology/space')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/science-technology/others', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/science-technology/others')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/aquatic-life/dolphins', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/aquatic-life/dolphins')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/aquatic-life/fish', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/aquatic-life/fish')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/aquatic-life/manatee', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/aquatic-life/manatee')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/aquatic-life/seals', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/aquatic-life/seals')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/aquatic-life/crustaceans', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/aquatic-life/crustaceans')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/aquatic-life/other-aquatic-life', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/aquatic-life/other-aquatic-life')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/birds/eagles', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/birds/eagles')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/birds/flamingo', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/birds/flamingo')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/birds/ducks-loons', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/birds/ducks-loons')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/birds/hawk', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/birds/hawk')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/birds/peacock', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/birds/peacock')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/birds/other-birds', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/birds/other-birds')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/insect-bugs/ant', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/insect-bugs/ant')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/insect-bugs/bee-wasp', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/insect-bugs/bee-wasp')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/insect-bugs/dragonfly', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/insect-bugs/dragonfly')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/insect-bugs/beetles', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/insect-bugs/beetles')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/insect-bugs/other-insect-bugs', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/insect-bugs/other-insect-bugs')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/dogs-puppies/akita', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/dogs-puppies/akita')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/dogs-puppies/dalmatian', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/dogs-puppies/dalmatian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/dogs-puppies/french-bulldog', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/dogs-puppies/french-bulldog')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/dogs-puppies/pug', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/dogs-puppies/pug')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/dogs-puppies/other-dogs-puppies', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/dogs-puppies/other-dogs-puppies')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/farm-animals/chickens', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/farm-animals/chickens')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/farm-animals/cows-bulls', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/farm-animals/cows-bulls')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/farm-animals/sheep', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/farm-animals/sheep')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/animals/farm-animals/other-farm-animals', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/animals/farm-animals/other-farm-animals')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/yoruba-society-people', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/yoruba-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/igbo-society-people', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/igbo-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/hausa-society-people', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/hausa-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/fulani-society-people', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/fulani-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/ibibio-society-people', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/ibibio-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/tiv-society-people', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/tiv-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/nigerian-textiles-sculptures', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/nigerian-textiles-sculptures')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/nigerian-tribal-masks', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/nigerian-tribal-masks')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/other-nigerian', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/nigerian/other-nigerian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/african-society-people', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/african-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/african-textiles-sculptures', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/african-textiles-sculptures')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/african-tribal-masks', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/african-tribal-masks')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/other-african', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/african/other-african')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian/indian', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian/indian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian/chinese', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian/chinese')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian/japanese', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian/japanese')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian/thai', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian/thai')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian/other-asian-indian', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/ethnic-cultural-tribal/asian-indian/other-asian-indian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/lilies', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/lilies')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/roses', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/roses')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/tulips', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/tulips')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/wisteria', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/wisteria')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/angelica', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/angelica')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/other-flowers', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/flowers/other-flowers')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/plants/acorns', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/plants/acorns')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/plants/cactus-cacti', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/plants/cactus-cacti')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/plants/grasses', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/plants/grasses')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/sculptures-carvings/flowers-plants-trees/plants/other-plants', function()
{
		...
		return View::make('buy/artworks/sculptures-carvings/flowers-plants-trees/plants/other-plants')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/aquatic-life/dolphins', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/aquatic-life/dolphins')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/aquatic-life/fish', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/aquatic-life/fish')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/aquatic-life/manatee', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/aquatic-life/manatee')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/aquatic-life/seals', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/aquatic-life/seals')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/aquatic-life/crustaceans', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/aquatic-life/crustaceans')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/aquatic-life/other-aquatic-life', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/aquatic-life/other-aquatic-life')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/birds/eagles', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/birds/eagles')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/birds/flamingo', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/birds/flamingo')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/birds/ducks-loons', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/birds/ducks-loons')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/birds/hawk', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/birds/hawk')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/birds/peacock', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/birds/peacock')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/birds/other-birds', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/birds/other-birds')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/insect-bugs/ant', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/insect-bugs/ant')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/insect-bugs/bee-wasp', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/insect-bugs/bee-wasp')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/insect-bugs/dragonfly', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/insect-bugs/dragonfly')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/insect-bugs/beetles', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/insect-bugs/beetles')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/insect-bugs/other-insect-bugs', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/insect-bugs/other-insect-bugs')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/dogs-puppies/akita', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/dogs-puppies/akita')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/dogs-puppies/dalmatian', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/dogs-puppies/dalmatian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/dogs-puppies/french-bulldog', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/dogs-puppies/french-bulldog')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/dogs-puppies/pug', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/dogs-puppies/pug')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/dogs-puppies/other-dogs-puppies', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/dogs-puppies/other-dogs-puppies')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/farm-animals/chickens', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/farm-animals/chickens')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/farm-animals/cows-bulls', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/farm-animals/cows-bulls')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/farm-animals/sheep', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/farm-animals/sheep')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/animals/farm-animals/other-farm-animals', function()
{
		...
		return View::make('buy/artworks/paintings-prints/animals/farm-animals/other-farm-animals')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/flowers/lilies', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/flowers/lilies')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/flowers/roses', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/flowers/roses')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/flowers/tulips', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/flowers/tulips')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/flowers/wisteria', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/flowers/wisteria')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/flowers/angelica', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/flowers/angelica')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/flowers/other-flowers', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/flowers/other-flowers')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/plants/acorns', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/plants/acorns')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/plants/cactus-cacti', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/plants/cactus-cacti')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/plants/grasses', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/plants/grasses')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/flowers-plants-trees/plants/other-plants', function()
{
		...
		return View::make('buy/artworks/paintings-prints/flowers-plants-trees/plants/other-plants')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/celebrity/actors', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/celebrity/actors')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/celebrity/actresses', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/celebrity/actresses')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/celebrity/musicians', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/celebrity/musicians')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/celebrity/other-celebrity', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/celebrity/other-celebrity')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/animation-anime-comics/animation', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/animation-anime-comics/animation')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/animation-anime-comics/anime', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/animation-anime-comics/anime')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/animation-anime-comics/comics', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/animation-anime-comics/comics')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/animation-anime-comics/others', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/animation-anime-comics/others')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/occupations/actor', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/occupations/actor')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/occupations/astronaut', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/occupations/astronaut')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/occupations/chef', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/occupations/chef')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/occupations/doctor-dentists', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/occupations/doctor-dentists')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/occupations/musician', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/occupations/musician')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/occupations/other-occupations', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/occupations/other-occupations')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/potrait/female', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/potrait/female')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/potrait/male', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/potrait/male')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/potrait/couples', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/potrait/couples')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/people-figures/potrait/other-potrait', function()
{
		...
		return View::make('buy/artworks/paintings-prints/people-figures/potrait/other-potrait')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/yoruba-society-people', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/yoruba-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/igbo-society-people', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/igbo-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/hausa-society-people', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/hausa-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/fulani-society-people', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/fulani-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/ibibio-society-people', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/ibibio-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/tiv-society-people', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/tiv-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/nigerian-textiles-paintings', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/nigerian-textiles-paintings')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/nigerian-tribal-masks', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/nigerian-tribal-masks')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/other-nigerian', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/nigerian/other-nigerian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/african-society-people', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/african-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/african-textiles-paintings', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/african-textiles-paintings')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/african-tribal-masks', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/african-tribal-masks')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/other-african', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/african/other-african')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/indian', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/indian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/chinese', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/chinese')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/japanese', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/japanese')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/thai', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/thai')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/other-asian-indian', function()
{
		...
		return View::make('buy/artworks/paintings-prints/ethnic-cultural-tribal/asian-indian/other-asian-indian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/aquatic-life/dolphins', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/aquatic-life/dolphins')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/aquatic-life/fish', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/aquatic-life/fish')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/aquatic-life/manatee', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/aquatic-life/manatee')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/aquatic-life/seals', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/aquatic-life/seals')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/aquatic-life/crustaceans', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/aquatic-life/crustaceans')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/aquatic-life/other-aquatic-life', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/aquatic-life/other-aquatic-life')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/birds/eagles', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/birds/eagles')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/birds/flamingo', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/birds/flamingo')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/birds/ducks-loons', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/birds/ducks-loons')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/birds/hawk', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/birds/hawk')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/birds/peacock', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/birds/peacock')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/birds/other-birds', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/birds/other-birds')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/insect-bugs/ant', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/insect-bugs/ant')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/insect-bugs/bee-wasp', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/insect-bugs/bee-wasp')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/insect-bugs/dragonfly', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/insect-bugs/dragonfly')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/insect-bugs/beetles', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/insect-bugs/beetles')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/insect-bugs/other-insect-bugs', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/insect-bugs/other-insect-bugs')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/dogs-puppies/akita', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/dogs-puppies/akita')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/dogs-puppies/dalmatian', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/dogs-puppies/dalmatian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/dogs-puppies/french-bulldog', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/dogs-puppies/french-bulldog')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/dogs-puppies/pug', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/dogs-puppies/pug')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/dogs-puppies/other-dogs-puppies', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/dogs-puppies/other-dogs-puppies')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/farm-animals/chickens', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/farm-animals/chickens')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/farm-animals/cows-bulls', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/farm-animals/cows-bulls')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/farm-animals/sheep', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/farm-animals/sheep')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/animals/farm-animals/other-farm-animals', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/animals/farm-animals/other-farm-animals')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/yoruba-society-people', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/yoruba-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/igbo-society-people', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/igbo-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/hausa-society-people', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/hausa-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/fulani-society-people', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/fulani-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/ibibio-society-people', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/ibibio-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/tiv-society-people', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/tiv-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/nigerian-textiles-drawings', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/nigerian-textiles-drawings')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/nigerian-tribal-masks', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/nigerian-tribal-masks')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/other-nigerian', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/nigerian/other-nigerian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african/african-society-people', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african/african-society-people')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african/african-textiles-drawings', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african/african-textiles-drawings')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african/african-tribal-masks', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african/african-tribal-masks')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african/other-african', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/african/other-african')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/indian', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/indian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/chinese', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/chinese')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/japanese', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/japanese')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/thai', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/thai')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/other-asian-indian', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/ethnic-cultural-tribal/asian-indian/other-asian-indian')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/lilies', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/lilies')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/roses', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/roses')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/tulips', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/tulips')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/wisteria', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/wisteria')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/angelica', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/angelica')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/other-flowers', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/flowers/other-flowers')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/plants/acorns', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/plants/acorns')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/plants/cactus-cacti', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/plants/cactus-cacti')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/plants/grasses', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/plants/grasses')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('buy/artworks/drawings-illustration/flowers-plants-trees/plants/other-plants', function()
{
		...
		return View::make('buy/artworks/drawings-illustration/flowers-plants-trees/plants/other-plants')->with(
												array('cart_content'=>$contents,
											   'carttotal'=>$carttotal,
											   'arts'=>$arts,
											   'menutype1'=>$menutype1,
...
Route::get('selected-art/{subsubsubcat_id}/{artid}', function($subsubsubcat_id,$artid)
{
   ...
   return View::make('selected-art')->with(array('cart_content'=>$contents,
   													 'carttotal'=>$carttotal,
...
Route::get('art/{cattype_id}/{ssscid}', function($cattype_id,$ssscid)
{
   ...
   $carttotal = Cart::total();
	...
	if($art_detail==0){
		...
		return View::make('art')->with(array('cart_content'=>$contents,
												 'carttotal'=>$carttotal,
												 'art_details'=>$art_details,
...
if(!is_numeric($artwork_qty)){
	...
	return Redirect::to("selected-art/$subsubsubcat_id/$artwork_id")->with('qty_error','number not numeric');
	...
	return View::make('selected-art')->with(array('art_details'=>$art_details,
													 'relatedarts'=>$relatedarts,
													 'artist_details'=>$artist_details,
													 'carttotal'=>$carttotal,
...
Route::get('cart-remove/{subsubsubcat}/{aid}/{id}', function($subsubsubcat,$aid,$id)
{
   ...
   Cart::remove($rowId);
	...
	return Redirect::to('selected-art/'.$subsubsubcat_id.'/'.$aid);
...
Route::get('view-cart', function()
{
	 ...
	 return View::make('view-cart')->with(array('cart_content'=>$contents,
	 											'carttotal'=>$carttotal,
												 'menu1'=>$menu1,
											     'menu2'=>$menu2
											   ));
...
Route::post('register', function()
{
	$validator = Validator::make(
	   ...
	   $user->customer_name=Input::get('customer_name');
	   $user->gender=Input::get('gender');
	   $user->remember_token=Input::get('rememberToken()');
	   $user->account_type="0";
...
Route::get('artist-login-register', function()
{
	...
	return View::make('artist-login-register')->with(array('country'=>$country));
});
...
Route::post('artist-signup', function()
{
	...
	$validator = Validator::make(
	 ...
	 if ($validator->passes()){
		...
		$artists=User::where('account_type', '=', '1')->get();
	   ...
	   $artist_state = DB::table('state')->where('state_id', Input::get('state'))->first();
      ...
      Session::flash('msg', 'Registration successful! Please wait for activation via your email, this might take some time. Thanks');
		 ...
		 return Redirect::to('artist-login-register');
		
		 
		 }else{
		   return Redirect::to('artist-login-register')->with(
            'error',
            'Please correct the following errors:'
        )->withErrors($validator);
	...
	$validator = Validator::make(
		 ...
		 if ($validator->passes()){
			...
			if (Auth::attempt($artistdata)) {
				...
				$userresults=User::where('email', '=', $artist_email)->first();
				...
				// validation not successful, send back to form 
				return Redirect::to('artist-login-register')->with('flash_error', 'Your username/password combination was incorrect.')
            ->withInput();
...
Route::get('/artist/profile', array(
		...
		function()
{
	return View::make('artist/profile');
}
));
...
{
	return View::make('artist/upload');
});


Route::get('artist/upload',array('before'=>'auth' , function()
{
		 ...
		 $categorytype = DB::table('categorytype')->where('relatea', '1')->lists('cattype_name', 'ctid');
	       ...
	       return View::make('artist/upload')->with(array('totalArtworks'=>$totalArtworks,
...
Route::get('artist.new', function()
{
	...
	$menu2 = DB::table('subsubsubcategories')->where('cattype_id','2')->get();
	      ...
	      $totalArtworks =DB::table($table)->where('user_id',$uid)->count();
			...
			return View::make('artist.new')->with(array('totalArtworks'=>$totalArtworks,
														'categorytype'=>$categorytype,
														'artist_details'=>$artist_details,
												 			'menu1'=>$menu1,
												  			'menu2'=>$menu2
...
{
	$artwork_cattype = Input::get('artwork_categorytype');
	$artwork_cat = Input::get('artwork_category');
	$artwork_subcat = Input::get('artwork_subcategory');
	$artwork_subsubcat = Input::get('artwork_subsubcategory');
	$artwork_subsubsubcat = Input::get('artwork_subsubsubcategory');
	$artist_name = Input::get('artist_name');
	$artwork_name = Input::get('artwork_name');
	$artwork_price = Input::get('artwork_price');
	$artwork_description = Input::get('artwork_description');
	$table = 'arts';
	$artist_id = Session::get('uid');
	
	$artwork_image = Input::get('artwork_image');

	// $product_size = json_encode(Input::get('product_size'));

    $artwork_image1 = Input::get('artwork_image1');
	...
	//return $artwork_price;
          ...
          $artwork_price = str_replace(",","",Input::get('artwork_price'));
                              }else{
	...
	if($artwork_image1 == "secret"){
		...
		return Redirect::to('artist/upload')->with('img_error', 'First image cannot be empty..')
            ->withInput();
		
		//return Redirect::to('artist.upload');
...
/*Route::get('artist/view-edit-artworks/{cattypeId}/{catId}/{subCatId}/{subsubCatId}/{subsubsubCatId}}', array('before'=>'auth',  function($cattypeId,$catId,$subCatId,$subsubCatId,$subsubsubCatId)
{
		 ...
		 //$categorytype = DB::table('categorytype')->where('relatea', '1')->lists('cattype_name', 'ctid');
	       ...
	       return View::make('artist/view-edit-artworks')->with(array('totalArtworks'=>$totalArtworks,
		   												//'categorytype'=>$categorytype,
														'cat'=>$cat->cat_name,
														//'artist_details'=>$artist_details,
...
Route::get('artist/view-edit-artworks/{cattypeId}/{catId}', array('before'=>'auth',  function($cattypeId,$catId)
{
...
Route::get('artist/view-edit-artworks/', array('before'=>'auth',  function()
{
...
Route::post('artist/view-edit-artworks', function()
{
	...
	$new_artworkName = Input::get('artwork_name');
	$new_artworkPrice = Input::get('price');
...
Route::get('artist/view_order',array('before'=>'auth' , function()
{
	      $menu1 = DB::table('subsubsubcategories')->where('cattype_id','1')->get();
	 ...
	 return View::make('artist/view_order')->with(array('order_details'=>$order_details,
...
Route::get('artist.account',array('before'=>'auth' , function()
{
     ...
     return View::make('artist.account')->with(array('act_details'=>$act_details,
	 															   'menu1'=>$menu1,
																   'menu2'=>$menu2,
																   'menu3'=>$menu3,
																   'menu4'=>$menu4,
...
Route::post('artist.account',array('before'=>'auth' , function()
{
	
	  $uid = Session::get('uid');
	  $bank_name = Input::get('bank_name');
	  $act_no = Input::get('act_no');
...
/*Route::get('artist/delete_artwork/{cattypeId}/{catId}/{artwork_id}', array('before'=>'auth', function($cattypeId,$catId,$artwork_id)
{
	$table='arts';
	$id = $artwork_id;
	$uid = Session::get('uid');
	...
	return Redirect::to("artist/view-edit-artwork/{cattypeId}/{catId}");
...
/*Route::get('artist/delete_artwork/{cattypeId}/{catId}/{subCatId}/{subsubCatId}/{subsubsubCatId}/{artwork_id}',array('before'=>'auth' ,function($cattypeId,$catId,$subCatId,$subsubCatId,$subsubsubCatId,$artwork_id)
{
	$table='arts';
	$id = $artwork_id;
	$uid = Session::get('uid');
	...
	return Redirect::to("artist/view-edit-artwork/$cattypeId/$catId/$subCatId/$subsubCatId/$subsubsubCatId/$artwork_id");
...
Route::get('artist/delete_artwork/{cattypeId}/{catId}/{subCatId}/{subsubCatId}/{subsubsubCatId}/{artwork_id}',array('before'=>'auth' ,function($cattypeId,$catId,$subCatId,$subsubCatId,$subsubsubCatId,$artwork_id)
{
	...
	return Redirect::to("artist/view-edit-artworks/{$cattypeId}/{$catId}");
...
Route::get('delivery-info-checkout', function()
{
	...
	return View::make('delivery-info-checkout')->with(array('cart_content'=>$contents,
																'carttotal'=>$carttotal,
																'menu1'=>$menu1,
																   'menu2'=>$menu2
																   ));
...
Route::post('delivery-info-checkout', array('before'=>'auth', function()
{
	$validator = Validator::make(
        Input::all(),
        array(
	...
	return Redirect::to('checkout');
		   ...
		   return Redirect::to('delivery-info-checkout')->with(
            'error',
            'Please correct the following errors:'
        )->withErrors($validator);
...
Route::get('checkout', array('before'=>'auth', function()
{
	...
	//Cart::update($rowId, array('name' => 'Product 1'));
					 return View::make('checkout')->with(array(
					 										'cart_content'=>$contents,
															'carttotal'=>$carttotal,
															'totalqty'=>$totalqty,
															'shippings'=>$shippings,
...
Route::post('checkout', function()
{
	...
	if(Input::get('payment')=='onDelivery'){
	...
	$shippings = DB::table('delivery')->where('state', '=', $state)->get();
	  ...
	  // $user->vend_phone = $vendor_phone;  
	   ...
	   return Redirect::to('order_complete');
...
$full_details,'order_details'=>$order_details), function($message) use ($admin)
	...
	//return $order_details->cust_firstname;
							...
							return View::make('order_complete')->with(array('order_details'=>$order_details,
	...
	$validator = Validator::make(
		 ...
		 if ($validator->passes()){
			...
			//return('hello');
				...
				// validation not successful, send back to form 
				return Redirect::to('admin')->with('flash_error', 'Your username/password combination was incorrect.')
            ->withInput();
...
Route::get('admin/index',array('before'=>'auth' , function()
{
   ...
   $last_orders = DB::table(DB::raw('(' . $sub->toSql() . ') as sub'))->latest()->get();
	...
	//return($result);
	  ...
	  return View::make('admin/index')->with(array('total_artists'=>$total_artists,'total_vendors'=>$total_vendors,'total_customers'=>$total_customers,'total_orders'=>$total_orders,'total_orders_pending'=>$total_orders_pending,'total_sales'=>$total_sales,'last_orders'=>$last_orders, 'menu1'=>$menu1,
																   'menu2'=>$menu2
																   ));
...
Route::get('admin/view_customers', array('before'=>'auth' ,function()
{
       
      $customer_details = DB::table('users')->where('account_type', '=', '0')->orderBy('uid', 'desc')->paginate(20);
	  
	 return View::make('admin/view_customers')->with(array('customer_details'=>$customer_details));
	 
	 
}));

Route::get('admin/view_artists',array('before'=>'auth' , function()
{
	 ...
	 return View::make('admin/view_artists')->with(array('artist_details'=>$artist_details));
	 
	 
}));

Route::get('admin/view_vendors',array('before'=>'auth' , function()
{
	 ...
	 return View::make('admin/view_vendors')->with(array('vendor_details'=>$vendor_details));
...
Route::get('admin/view_orders/{artistId}', function($artistId)
{
	  ...
	  return View::make('admin/view_orders')->with(array('order_details'=>$order_details,'order_count'=>$order_count));
...
Route::get('admin/view_all_orders',array('before'=>'auth' , function()
{
...
Route::get('admin/activate_artist/{artistId}',array('before'=>'auth' , function($artistId)
{
       $artist_id = $artistId;
	  ...
	  return Redirect::to('admin/view_artists');
	  

	  //return View::make('backend.view_order')->with(array('order_details'=>$order_details,'order_count'=>$order_count));
	 
	 
}));

Route::get('admin/activate_vendor/{vendorId}',array('before'=>'auth' , function($vendorId)
{
       $vendor_id = $vendorId;
	  ...
	  return Redirect::to('admin/view_vendors');
...
Route::get('admin/deactivate_artist/{artistId}',array('before'=>'auth' , function($artistId)
{
       $artist_id = $artistId;
...
Route::get('admin/deactivate_vendor/{vendorId}',array('before'=>'auth' , function($vendorId)
{
       $vendor_id = $vendorId;
...
Route::get('admin/delete_artist/{artistId}',array('before'=>'auth' , function($artistId)
{
       $artist_id = $artistId;
...
Route::get('admin/delete_vendor/{vendorId}',array('before'=>'auth' , function($vendorId)
{
       $vendor_id = $vendorId;
...
Route::get('admin/delivery',array('before'=>'auth' , function()
{
	      $menu1 = DB::table('subsubsubcategories')->where('cattype_id','1')->get();
		  $menu2 = DB::table('subsubsubcategories')->where('cattype_id','2')->get();
          ...
          return View::make('admin/delivery')->with(array('delivery_info'=>$delivery_info,
...
Route::post('admin/delivery',array('before'=>'auth' , function()
{
	
	  $did = Input::get('delivery_id');
...
Route::get('admin/add_delivery',array('before'=>'auth' , function()
{
     return View::make('admin/add_delivery');
}));
...
Route::post('admin/add_delivery', function()
{
	...
	$validator = Validator::make(
	  ...
	  Session::flash('adddelivery_msg','Fare successfully added!');
		 ...
		 return Redirect::to('admin/add_delivery');
		
		 
		 }else{
		   return Redirect::to('admin/add_delivery')->with(
            'error',
            'Please correct the following errors:'
        )->withErrors($validator);
...
Route::get('admin/deliver_art/{orderId}',array('before'=>'auth' , function($orderId)
{
       $order_id = $orderId;
	  ...
	  //return Redirect::to('admin.view_order.'.$vendor_details->vend_id);
	 return Redirect::to('admin/view_all_orders'); 
...
Route::get('admin/payfor_art/{orderId}',array('before'=>'auth' , function($orderId)
{
       $order_id = $orderId;
...
Route::get('admin/add_admin',array('before'=>'auth' , function()
{
	...
	$validator = Validator::make(
	  ...
	  Session::flash('admin_msg','Admin successfully created!');
		 ...
		 return Redirect::to('admin/add_admin');
		   ...
		   return Redirect::to('admin/add_admin')->with(
            'error',
            'Please correct the following errors:'
        )->withErrors($validator);
